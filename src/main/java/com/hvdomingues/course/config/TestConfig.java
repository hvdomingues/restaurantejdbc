package com.hvdomingues.course.config;
...
import com.hvdomingues.course.entities.Payment;
import com.hvdomingues.course.entities.Product;
import com.hvdomingues.course.entities.User;
import com.hvdomingues.course.entities.enums.OrderStatus;
import com.hvdomingues.course.repositories.CategoryRepository;
import com.hvdomingues.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Order o2 = new Order(null, Instant.parse("2019-06-20T19:53:07Z").parse("2019-07-21T03:42:10Z"), OrderStatus.PAID, u2);
